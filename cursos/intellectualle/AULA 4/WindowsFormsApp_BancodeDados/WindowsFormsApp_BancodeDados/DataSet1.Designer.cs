...
namespace WindowsFormsApp_BancodeDados {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(int Id, string nome, string rua) {
...
namespace WindowsFormsApp_BancodeDados.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND" +
                " [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_rua = 1 AND [rua] I" +
                "S NULL) OR ([rua] = @Original_rua)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [nome], [rua]) VALUES (@Id, @nome, @rua);\r\nSELEC" +
                "T Id, nome, rua FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [nome] = @nome, [rua] = @rua WHERE (([Id] = @Original_Id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_rua = 1 AND [rua] IS NULL) OR ([rua] = @Original_rua)));
SELECT Id, nome, rua FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp_BancodeDados.Properties.Settings.Default.testeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, nome, rua FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_nome, string Original_rua) {
        ...
        public virtual int Insert(int Id, string nome, string rua) {
        ...
        public virtual int Update(int Id, string nome, string rua, int Original_Id, string Original_nome, string Original_rua) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, string rua, int Original_Id, string Original_nome, string Original_rua) {
            return this.Update(Original_Id, nome, rua, Original_Id, Original_nome, Original_rua);
        }
    }
